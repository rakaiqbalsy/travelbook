    ...
    if ($act == 'insert') {
        ...
        if (isset($_POST['simpan'])) {
          ...
          // die;
            ...
            $query = mysqli_query($mysqli, "INSERT INTO pembelian(id_pembelian, nama_user,tgl_pembelian,id_jadwal,harga,jumlah_tiket,subtotal,tgl_berangkat, id_user)
                VALUES ('$id_pembelian','$id_pelanggan','$tgl_pembelian','$id_jadwal','$harga','$jumlah_tiket','$subtotal','$tgl_berangkat','$data_id')")
