...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="kata">
          <h2>Rute<span> & </span>Jadwal Pemberangkatan</h2>
      </div>
    </div>
    <!-- akhir jumbotron -->
...
<!--                 <a href="bjb.html"> -->
        ...
        <h2>Jadwal Pemberangkatan</h2>
          <div class="col-sm-8">
            <<div class="card-deck">
              <div class="card col-sm4 col-sm2"> 
                <img src="img/bdg.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Bandung - Yogyakarta</h5>
                  <p class="card-text">Setiap Hari jam 08.00 | 12.00 | 16.00 </p>
                  <p> Harga RP. 120.000,00 / Tiket </p>
                </div>
            ...
            <div class="card col-sm4">
              <img src="img/yogya.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Yogyakarta - Bandung</h5>
                <p class="card-text">Setiap Hari jam 08.00 | 12.00 | 16.00 </p>
                <p> Harga RP. 120.000,00 / Tiket </p>
              </div>
                <div class="card-footer">
