...
<section class="content-header">
  <h1>
  <i class="fa fa-edit icon-title"></i> Data Transaksi Pembatalan
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
    <li><a href="?module=pembatalan"> Data Transaksi Pembatalan </a></li>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <!-- form start -->
      <form role="form" class="form-horizontal" action="modules/pembatalan/proses.php?act=insert" method="POST" name="formpembatalan">
          <div class="box-body">
            <?php
            ...
            $id_pembatalan = "PMB-$tahun-$buat_id";
            ?>
