...
$query = mysqli_query($mysqli, "SELECT id_pembayaran,id_pembelian,tgl_transaksi,subtotal,status FROM pembayaran ORDER BY id_pembayaran ASC")
        ...
        while ($data = mysqli_fetch_assoc($query)) {
           ...
           // $harga_jual = format_rupiah($data['harga_jual']);
            ...
            echo "  <tr>
                        ...
                        <td width='100' height='13' align='center' valign='middle'>$data[id_pembayaran]</td>
                        <td width='100' height='13' align='center' valign='middle'>$data[id_pembelian]</td>
                        <td style='padding-left:5px;' width='100' height='13' valign='middle'>$data[tgl_transaksi]</td>
                        <td style='padding-left:5px;' width='100' height='13' valign='middle'>$data[subtotal]</td>
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[status]</td>
                    </tr>";
            $no++;
        }
        ?>  
