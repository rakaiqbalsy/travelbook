    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00a65a;color:#fff" class="small-box">
          ...
          <?php  
          if ($_SESSION['hak_akses']!='Manajer') { ?>
            <a href="?module=form_pembayaran&form=add" class="small-box-footer" title="Tambah Data" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
            <a class="small-box-footer"><i class="fa"></i></a>
          <?php
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#f39c12;color:#fff" class="small-box">
          <div class="inner">
            <?php  
            // fungsi query untuk menampilkan data dari tabel obat
            $query = mysqli_query($mysqli, "SELECT COUNT(id_pembatalan) as jumlah FROM pembatalan")
          ...
          <div class="icon">
           ...
           <?php  
          if ($_SESSION['hak_akses']!='Manajer') { ?>
            <a href="?module=form_pembatalan&form=add" class="small-box-footer" title="Tambah Data" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
            <a class="small-box-footer"><i class="fa"></i></a>
          <?php
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#dd4b39;color:#fff" class="small-box">
          <div class="inner">
            <?php   
            // fungsi query untuk menampilkan data dari tabel obat masuk
            $query = mysqli_query($mysqli, "SELECT COUNT(id_pelanggan) as jumlah FROM data_pelanggan")
          ...
          <div class="icon">
           ...
           <?php  
          if ($_SESSION['hak_akses']!='Manajer') { ?>
            <a href="?module=form_pelanggan&form=add" class="small-box-footer" title="Tambah Data" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
            <a class="small-box-footer"><i class="fa"></i></a>
          <?php
